...
public class SstoehrHars {
    public static String toString(@Nullable HarCreatorBrowser h) {
        if (h == null) {
            return "null";
        }
    ...
    public static String toString(@Nullable HarRequest r) {
        return String.format("%s %s %s (%s headers, %s cookies, body size = %s)",
                r.getHttpVersion(), r.getMethod(), r.getUrl(),
    ...
    public static String toString(@Nullable HarPageTiming p) {
        if (p == null) {
            return "null";
        }
        return MoreObjects.toStringHelper(p)
    ...
    public static void dumpInfo(de.sstoehr.harreader.model.Har har, PrintStream out) throws IOException {
