...
public class BmpHars {
    ...
    public static String toString(@Nullable HarPage p) {
        ...
        return MoreObjects.toStringHelper(p)
                ...
                .add("comment", p.getComment())
                .add("startedDateTime", p.getStartedDateTime())
                .add("pageTimings", toString(p.getPageTimings()))
                .toString();
    }
    ...
    public static String toString(@Nullable HarEntry he) {
        ...
        return MoreObjects.toStringHelper(he)
                ...
                .add("time", he.getTime())
                .add("request", toString(he.getRequest()))
                .add("response", toString(he.getResponse()))
                .add("serverIPAddress", he.getServerIPAddress())
                .add("connection", he.getConnection())
                .add("comment", he.getComment())
                .toString();
    }
    ...
    public static String toString(@Nullable HarRequest r) {
        return String.format("%s %s %s (%s cookies, %s headers, body size = %s)", r.getHttpVersion(), r.getMethod(), r.getUrl(), size(r.getHeaders()), size(r.getCookies()), r.getBodySize());
    }

    public static String toString(@Nullable HarResponse r) {
        return String.format("%s %s %s (%s cookies, %s headers, body size = %s)",
                r.getHttpVersion(), r.getStatus(), r.getStatusText(), size(r.getHeaders()), size(r.getCookies()), r.getBodySize());
    }
    ...
    public static String toString(@Nullable HarPageTimings p) {
        ...
        return MoreObjects.toStringHelper(p)
                .add("onLoad", p.getOnLoad())
                .add("onContentLoad", p.getOnContentLoad())
                .toString();

    }

    public static void dumpInfo(net.lightbody.bmp.core.har.Har har, PrintStream out) throws IOException {
